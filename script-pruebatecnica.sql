...
CREATE TABLE roles (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY username_unique (nombre)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE usuarios_roles (
  id_usuarios int(11) NOT NULL,
  id_roles int(11) NOT NULL,
  constraint usuarios_roles_unique unique (id_usuarios, id_roles),
  constraint usuarios_roles_ibfk_2 foreign key (id_roles) references roles (id),
  constraint usuarios_roles_ibfk_3 foreign key (id_usuarios) references usuarios (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
